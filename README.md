...
|----------|----------|----------|----------|---------|----------|
| ImmortalWrt `master` | 已发布 | `immortalwrt-master-2026.09.23-2210` | 2026-09-23 22:10 CST | [下载](https://github.com/hellomrli/my-ImmortalWrt/releases/tag/immortalwrt-master-2026.09.23-2210) | `squashfs-combined-efi.img.gz` |
| ImmortalWrt `openwrt-25.12` | 已发布 | `immortalwrt-openwrt-25.12-2026.09.22-1219` | 2026-09-22 12:19 CST | [下载](https://github.com/hellomrli/my-ImmortalWrt/releases/tag/immortalwrt-openwrt-25.12-2026.09.22-1219) | `squashfs-combined-efi.img.gz` |
